...
export default function EmailCta() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-lg mx-auto mt-[-16px] mb-[-16px]">
      <div className="mx-auto w-full max-w-lg backdrop-blur-3xl bg-white/10 border border-white/5 px-4 md:px-6 py-2 rounded-[24px] bg-gradient-to-br from-white/15 to-white/5">
