export default function EmailCta() {
  ...
  return (
    <div className="w-full max-w-lg mx-auto mt-[-16px] mb-[-16px] px-3 xs:px-4 sm:px-0">
      <div className="mx-auto w-full max-w-lg backdrop-blur-2xl bg-white/5 border border-white/5 px-1.5 xs:px-2 py-1.5 xs:py-2 rounded-[20px] xs:rounded-[22px] sm:rounded-[24px]">
