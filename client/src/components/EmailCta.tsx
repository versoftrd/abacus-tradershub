...
export default function EmailCta() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-3xl mx-auto">
      <div className="relative mx-auto w-full max-w-3xl rounded-[15px] border border-[#2a2a2a] bg-[#111417] px-4 md:px-6 py-2 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.02)] focus-within:ring-2 focus-within:ring-emerald-400/40 before:absolute before:inset-x-2 before:top-1 before:h-1/2 before:rounded-[15px] before:bg-white/5 before:blur-md before:content-['']">
