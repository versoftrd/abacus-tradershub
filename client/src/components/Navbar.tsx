            ...
            <div className="flex items-center gap-1 rounded-[16px] backdrop-blur-sm border border-white/10 px-2 py-1 bg-[#1a1a1a]">
              {navigationItems.map((item) => (
                <a
                  key={item.path}
                  href={item.path}
                  className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500/50 ${
                    isActive(item.path)
              ...
              <button 
                className="px-4 py-1.5 rounded-full bg-login-bg text-zinc-200 hover:bg-login-hover transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500/50 text-sm font-semibold"
                data-testid="button-login"
              >
                Login
              </button>
              <button 
                className="px-4 py-1.5 rounded-full bg-gradient-to-r from-gradient-start to-gradient-end text-white shadow-sm hover:opacity-95 transition-opacity duration-200 focus:outline-none focus:ring-2 focus:ring-sky-300/60 text-sm font-semibold"
        ...
        <div className="md:hidden border-t border-border-subtle bg-mobile-panel" data-testid="mobile-menu-panel">
          <div className="px-4 py-4 space-y-2">
            ...
            <div className="pt-4 space-y-2">
              <button 
                className="w-full px-4 py-2 rounded-full bg-login-bg text-zinc-200 hover:bg-login-hover transition-colors duration-200 text-sm font-semibold"
                data-testid="mobile-button-login"
              >
                Login
              </button>
              <button 
                className="w-full px-4 py-2 rounded-full bg-gradient-to-r from-gradient-start to-gradient-end text-white shadow-sm hover:opacity-95 transition-opacity duration-200 text-sm font-semibold"
