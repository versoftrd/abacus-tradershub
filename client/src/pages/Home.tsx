        ...
        <div className="relative max-w-6xl mx-auto px-1 sm:px-2 md:px-4 lg:px-6">
          ...
          >
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-start justify-center text-left px-6 py-8 sm:pl-[15%] sm:pr-8 sm:py-8 md:pl-[15%] md:pr-12 md:py-10 lg:pl-[15%] lg:pr-16 lg:py-12">
              ...
              {/* Heading */}
              <h2 
                className="font-sans text-white mb-3 sm:mb-1.5 md:mb-2 lg:mb-3 text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl max-w-[85%] sm:max-w-2xl font-semibold group-hover:text-blue-50 transition-colors duration-300 leading-tight"
              ...
              {/* Subheading */}
              <p 
                className="font-sans text-gray-300 mb-4 sm:mb-2 md:mb-3 lg:mb-4 text-xs sm:text-sm md:text-base lg:text-lg max-w-[85%] sm:max-w-xl lg:max-w-2xl group-hover:text-gray-200 transition-colors duration-300 leading-relaxed"
