...
import img1 from "@assets/img1_1756142351359.png";
    ...
    <div className="min-h-screen bg-page-bg overflow-x-hidden">
          ...
          <div className="responsive-grid responsive-grid-2 mx-auto px-2 sm:px-4 md:px-6" style={{ maxWidth: '85%' }}>
            ...
            <div className="group relative bg-[linear-gradient(to_bottom,#141820_0%,#141414_20%)] rounded-3xl p-4 sm:p-6 shadow-2xl hover:scale-105 transition-transform duration-300" style={{ border: '1px solid rgba(0, 85, 255, 0.1)' }} data-testid="card-weekly">
              ...
              <div className="mb-6 flex items-start gap-2">
                <span className="font-sans text-3xl sm:text-[40px] font-semibold text-white" data-testid="price-weekly">$300</span>
      ...
      <section className="relative bg-[#0a0a0a] py-8 sm:py-12 md:py-16 px-3 sm:px-4 md:px-6">
        ...
        <div className="relative max-w-6xl mx-auto px-1 sm:px-2 md:px-4 lg:px-6">
          {/* CTA Card */}
          <div 
            className="relative group cursor-pointer transition-all duration-500 hover:scale-[1.02] rounded-3xl sm:rounded-3xl overflow-hidden w-full bg-center bg-no-repeat sm:[background-size:cover]"
            style={{
          ...
          >
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-start justify-center text-left px-6 py-8 sm:pl-[15%] sm:pr-8 sm:py-8 md:pl-[15%] md:pr-12 md:py-10 lg:pl-[15%] lg:pr-16 lg:py-12">
              ...
              {/* Heading */}
              <h2 
                className="font-sans text-white mb-3 sm:mb-3 md:mb-4 lg:mb-6 text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl max-w-[85%] sm:max-w-2xl font-semibold group-hover:text-blue-50 transition-colors duration-300 leading-tight"
              ...
              {/* Subheading */}
              <p 
                className="font-sans text-gray-300 mb-4 sm:mb-4 md:mb-6 lg:mb-8 text-xs sm:text-sm md:text-base lg:text-lg max-w-[85%] sm:max-w-xl lg:max-w-2xl group-hover:text-gray-200 transition-colors duration-300 leading-relaxed"
