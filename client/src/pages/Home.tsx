      ...
      <section className="relative bg-[#141414] py-16 px-4 sm:px-6">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="font-sans sm:text-4xl md:text-5xl text-white mb-6 flex items-start justify-center gap-4 font-semibold text-[32px]" data-testid="nucleos-headline">
              Los 4 núcleos del <img src={logo} alt="Traders Hub Logo" className="h-10 sm:h-14 md:h-16 inline-block mt-[-3px] mb-[-3px]" />
            </h2>
